  ...
  return (
    <div className="hidden sm:flex flex-col p-2 xl:items-start fixed h-full">
        ...
        <div className="hoverEffect text-gray-700 flex items-center justify-center xl:justify-start mt-auto ">
          <img src="https://lh3.googleusercontent.com/a-/AFdZucqvsyLh0w1-foe12qK0_04ZhQ2VfzdqMh-MTnTs=s504-p-rw-no" alt="user-img" width="504" height="504" className="h-10 w-10 rounded-full xl:mr-2" />
